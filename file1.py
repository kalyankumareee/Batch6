...
--> RubtPython  -  Bridge between Python and Ruby Interprets
--> MicroPython -  Runs in Micro Controllers



Print function has 5 parameters: (object,sep,end,file,flush)
